...
FamilySystem: priority=52, tick_interval=365 (월간 체크)

### 출산 조건 (모든 AND)
1. partner 관계
2. 여성, 15~45세 (가임 연령)
3. 임신 중 아님
4. 출산 후 수유 무월경 쿨다운 경과 (8,760틱 = 730일 = 2년)
5. hunger ≥ 0.2 (극심한 기아 아님)

### 월간 임신 확률
- 기본 fecundability: 12%/월 (Wood 1994)
- 영양-출산력 수정자 (Frisch 1984):
  - hunger < 0.2: ×0.0 (무월경 — 임신 불가)
  - hunger 0.2~0.35: ×0.2
  - hunger 0.35~0.5: ×0.5
  - hunger 0.5~0.7: ×0.8
  - hunger ≥ 0.7: ×1.0
- 최종 확률 = 0.12 × nutrition_factor
- hunger=0.5 → 6%/월 → 평균 17개월 내 임신
- hunger=0.7 → 10%/월 → 평균 10개월 내 임신

### 기대 출산 간격
- 수유 무월경 2년 + 임신 280일 + 수태 시도 ~8개월 ≈ 3.5년
- 수렵채집 IBI: !Kung 4년, Hadza 3.5년, Ache 3년 (실측과 정합)
