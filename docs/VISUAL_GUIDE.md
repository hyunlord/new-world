...
### 우상단 미니맵 (200×200px 기본, M 토글):
- 기본 200px, M키 순환: 200px → 300px → 숨김 → 200px
...
### 우하단 통계 패널 (160×200px):
- 위치: **우하단** (키 힌트 위)
- 인구 그래프: 초록 polyline (`Color(0.2, 1.0, 0.4)`) (14px)
- 자원 그래프: food=노랑, wood=갈색, stone=회색 (12px)
...
### 우하단 키 힌트:
- 12px 회색 텍스트 (`Color(0.5, 0.5, 0.5, 0.6)`)
