...
use sim_systems::runtime::{
    ...
    BandBehaviorSystem, BandFormationSystem, BuildingEffectRuntimeSystem, TerritoryRuntimeSystem,
...
pub(crate) const DEFAULT_RUNTIME_SYSTEMS: [DefaultRuntimeSystemSpec; 65] = [
    ...
    DefaultRuntimeSystemSpec {
        system_id: RuntimeSystemId::Territory,
        priority: 55,
        tick_interval: 5,
    },
    DefaultRuntimeSystemSpec {
    ...
    DefaultRuntimeSystemSpec {
        system_id: RuntimeSystemId::HealthRuntime,
        priority: 110,
        tick_interval: 30,
    },
    DefaultRuntimeSystemSpec {
        system_id: RuntimeSystemId::WildlifeRuntime,
        priority: 115,
        tick_interval: 1,
    },
];
...
pub(crate) fn register_runtime_system(
    ...
    match system_id {
        ...
        RuntimeSystemId::Territory => {
            engine.register(TerritoryRuntimeSystem::new(priority_u32, tick_interval_u64))
        }
        ...
        RuntimeSystemId::HealthRuntime => engine.register(
            HealthRuntimeSystem::new(priority_u32, tick_interval_u64),
        ),
        RuntimeSystemId::WildlifeRuntime => engine.register(
            WildlifeRuntimeSystem::new(priority_u32, tick_interval_u64),
        ),
        RuntimeSystemId::LlmRequest => {
...
mod tests {
    ...
    fn default_runtime_manifest_is_unique_and_deterministic() {
        ...
        assert_eq!(
            ...
            RuntimeSystemId::WildlifeRuntime
        );
