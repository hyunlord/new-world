...
use crate::{
    EVENT_TYPE_ID_BIRTH_OCCURRED, EVENT_TYPE_ID_BUILDING_CONSTRUCTED,
    EVENT_TYPE_ID_ENTITY_DIED, EVENT_TYPE_ID_ENTITY_REMOVED, EVENT_TYPE_ID_ENTITY_SPAWNED,
    EVENT_TYPE_ID_ERA_ADVANCED, EVENT_TYPE_ID_FAMILY_FORMED, EVENT_TYPE_ID_GENERIC,
    EVENT_TYPE_ID_JOB_ASSIGNED, EVENT_TYPE_ID_MENTAL_BREAK_TRIGGERED,
    EVENT_TYPE_ID_MIGRATION_OCCURRED, EVENT_TYPE_ID_RELATIONSHIP_CHANGED,
    EVENT_TYPE_ID_RESOURCE_GATHERED, EVENT_TYPE_ID_SETTLEMENT_FOUNDED,
    EVENT_TYPE_ID_SIMULATION_PAUSED, EVENT_TYPE_ID_SIMULATION_RESUMED,
    EVENT_TYPE_ID_SOCIAL_EVENT_OCCURRED, EVENT_TYPE_ID_SPEED_CHANGED,
    EVENT_TYPE_ID_STRESS_CHANGED, EVENT_TYPE_ID_TECH_DISCOVERED,
    EVENT_TYPE_ID_TICK_COMPLETED,
};
