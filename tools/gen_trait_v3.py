...
EFFECTS = {
    ...
    "A_incorruptible": [
        {"system": "behavior", "target": ["accept_bribe", "steal", "fraud", "embezzle"], "op": "block", "value": True, "tags": ["integrity"]},
        ...
        {"system": "behavior", "target": ["compromise", "bluff", "deceive"], "op": "block", "value": True},
    ...
    "A_serpent_tongue": [
        {"system": "behavior", "target": ["fraud", "smuggle", "bribe", "forge_document"], "op": "enable", "value": True},
        {"system": "skill", "target": ["deception", "persuasion"], "op": "mult", "value": 1.4},
        {"system": "relationship", "target": "betrayal_cooldown", "op": "mult", "value": 0.0},
        {"system": "stress", "target": "betrayal_guilt", "op": "immune", "value": True},
    ...
    "A_stone_blood": [
        ...
        {"system": "emotion", "target": "fear", "op": "max", "value": 0.1},
        {"system": "emotion", "target": ["joy", "sadness", "trust", "surprise"], "op": "max", "value": 0.5},
        {"system": "relationship", "target": "intimacy_gain_rate", "op": "mult", "value": 0.5},
        {"system": "relationship", "target": "intimacy", "op": "max", "value": 70},
        {"system": "behavior", "target": ["console", "empathize", "cry", "express_grief"], "op": "block", "value": True},
    ...
    "A_open_palm": [
        ...
        {"system": "behavior", "target": ["refuse_request", "reject_proposal", "deny_entry"], "op": "block", "value": True},
    ...
    "A_clockwork": [
        ...
        {"system": "behavior", "target": ["break_rule", "skip_task", "shirk_duty"], "op": "block", "value": True},
    ...
    "A_root_bound": [
        ...
        {"system": "behavior", "target": ["adopt_innovation", "experiment", "research"], "op": "block", "value": True},
    ...
    "A_silver_mask": [
        ...
        {"system": "relationship", "target": "trust", "op": "max", "value": 50, "condition": "relationship_duration > 365"},
        {"system": "behavior", "target": "maintain_cover", "op": "enable", "value": True, "tags": ["espionage"]},
        {"system": "behavior", "target": "fake_emotion", "op": "enable", "value": True},
        {"system": "skill", "target": ["espionage", "diplomacy", "deception"], "op": "mult", "value": 1.5},
        {"system": "behavior", "target": ["express_true_feelings", "confess", "genuine_apology"], "op": "block", "value": True},
    ],
    "A_true_mirror": [
        {"system": "derived", "target": "charisma", "op": "add", "value": 0.3},
        {"system": "behavior", "target": ["lie", "deceive", "bluff", "fake_emotion"], "op": "block", "value": True},
    ...
    "A_tempest": [
        ...
        {"system": "emotion", "target": "anger", "op": "min", "value": 0.2},
    ...
    "A_still_water": [
        ...
        {"system": "emotion", "target": "anger", "op": "max", "value": 0.15, "condition": "trigger_type == 'insult' OR trigger_type == 'provocation'"},
    ...
    "A_war_drum": [
        ...
        {"system": "behavior", "target": "pre_battle_speech", "op": "enable", "value": {"morale_boost": 0.3, "duration": "combat"}},
    ...
    "A_obsidian_edge": [
        ...
        {"system": "behavior", "target": ["console", "empathize", "grant_leave"], "op": "block", "value": True, "condition": "target.role == 'subordinate'"},
    ...
    "A_living_library": [
        ...
        {"system": "event", "target": "cross_discipline_discovery", "op": "enable", "value": True},
    ...
    "A_iron_oath": [
        {"system": "behavior", "target": ["break_promise", "renegotiate", "abandon_task"], "op": "block", "value": True},
        ...
        {"system": "values", "target": "LAW", "op": "min", "value": 0.7},
    ],
    "A_quicksilver": [
        ...
        {"system": "stress", "target": "betrayal_guilt", "op": "immune", "value": True},
        {"system": "relationship", "target": "trust", "op": "max", "value": 40},
    ...
    "A_dreamer": [
        ...
        {"system": "event", "target": "dream_inspiration", "op": "enable", "value": {"chance_per_night": 0.05}},
    ...
    "A_fortress_mind": [
        ...
        {"system": "behavior", "target": ["adopt_innovation", "learn_new_skill", "accept_change", "experiment"], "op": "block", "value": True},
    ...
    "A_zealot": [
        ...
        {"system": "behavior", "target": ["compromise", "concede", "tolerance"], "op": "block", "value": True},
    ...
    "A_fox_path": [
        ...
        {"system": "behavior", "target": "maintain_cover", "op": "enable", "value": True},
        {"system": "relationship", "target": "betrayal_damage", "op": "mult", "value": 3.0},
        {"system": "behavior", "target": ["express_true_feelings", "genuine_apology"], "op": "block", "value": True},
        {"system": "derived", "target": "wisdom", "op": "add", "value": -0.2},
    ],
    # ── Shadow (5 traits) ──
    "S_hollow_crown": [
        {"system": "emotion", "target": "guilt", "op": "set", "value": 0.0},
        {"system": "emotion", "target": ["trust", "sadness"], "op": "max", "value": 0.15},
        {"system": "emotion", "target": "contempt", "op": "min", "value": 0.2},
        ...
        {"system": "behavior", "target": ["manipulate", "exploit", "charm_offensive", "cold_calculation"], "op": "enable", "value": True},
        {"system": "behavior", "target": ["genuine_empathy", "altruistic_help", "self_sacrifice", "console"], "op": "block", "value": True},
        {"system": "derived", "target": "charisma", "op": "add", "value": 0.2},
    ...
    "S_puppet_master": [
        ...
        {"system": "behavior", "target": "recruit_minion", "op": "enable", "value": {"loyalty_bonus": 0.4, "method": "calculated_charm"}},
        {"system": "relationship", "target": "mode", "op": "set", "value": "strategic"},
        {"system": "behavior", "target": "plausible_deniability", "op": "enable", "value": {"detection_reduction": 0.8}},
    ...
    "S_mirror_throne": [
        ...
        {"system": "emotion", "target": "anger", "op": "on_event", "value": {"on": "receives_criticism", "intensity": 0.8}},
    ...
    "S_cracked_mirror": [
        {"system": "behavior", "target": "sympathy_manipulation", "op": "enable", "value": {"effectiveness": 0.6}},
    ...
    "S_red_smile": [
        ...
        {"system": "behavior", "target": ["mercy", "spare_life", "forgive"], "op": "block", "value": True},
...
L = {
    ...
    "A_serpent_tongue": ("Serpent-Tongue", "뱀혀",
    ...
    "A_obsidian_edge": ("Obsidian Edge", "흑요석 칼날",
    ...
    "A_fortress_mind": ("Fortress Mind", "철벽 정신",
    ...
    "A_torch_bearer": ("Torch-Bearer", "횃불지기",
    ...
    "A_unmoving_peak": ("Unmoving Peak", "부동의 봉우리",
    ...
    "S_throne_hunger": ("Throne Hunger", "왕좌에 굶주린 자",
    ...
    "R_wellspring": ("Living Wellspring", "생명의 샘",
    ...
    "N_muse_touched": ("Muse-Marked", "뮤즈의 총아",
    ...
    "W_battle_forged": ("Battleborn", "전장에 벼려진 자",
    ...
    "W_touched_by_gods": ("God-Touched", "신의 손길을 입은 자",
    ...
    "W_wanderers_return": ("Returned Wanderer", "돌아온 방랑자",
    ...
    "L_silver_tongue_blood": ("Silver Tongue", "은빛 혀의 혈통",
    ...
    "L_beast_affinity": ("Beastkin", "짐승핏줄",
    ...
    "L_short_wick": ("Quickflame", "불붙는 성미",
    ...
    "L_echo_face": ("Echo Visage", "잔향의 얼굴",
    ...
    "M_death_dealer": ("Death Dealer", "죽음의 상인",
    ...
    "M_song_keeper": ("Song-Keeper", "노래지기",
    ...
    # ── Bond ──
    "D_soul_tethered": ("Soul-Tethered", "영혼결박",
    ...
    "D_twice_betrayed": ("Twice-Betrayed", "두 번 버림받은 자",
    ...
    "D_sworn_enemy": ("Sworn Enemy", "맹세의 원수",
    ...
    "D_river_between": ("River Between", "사이의 강",
    ...
    "F_twin_crowned": ("Twin-Crowned", "쌍관왕",
    ...
    "Y_truth_serum": ("Truth Serum", "진실의 약",
        ...
        "거부 불가 진심. 외교 최상."),
    "Y_chain_march": ("Chainbreaker March", "사슬파괴의 행진",
    ...
    "Y_pain_weaver": ("Pain-Weaver", "고통을 엮는 자",
        ...
        "고통을 예술로. 문화사 영원."),
    "Y_ashes_dawn": ("Ashen Dawn", "잿더미의 새벽",
    ...
    "Y_moons_cradle": ("Moon's Cradle", "달의 요람",
        ...
        "광기+천재 융합. 걸작과 재앙 번갈아."),
    "Y_blood_remembers": ("Blood Remembrance", "피의 기억",
