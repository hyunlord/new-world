...
def run(project_root: Path, strict_duplicates: bool, report_json: str = "") -> int:
    ...
    if report_json:
        ...
        report_payload: Dict[str, Any] = {
            ...
            "thresholds": {
                "max_duplicate_key_count": max_duplicate_key_count,
                "max_duplicate_conflict_count": max_duplicate_conflict_count,
                "max_missing_key_fill_count": max_missing_key_fill_count,
                "max_owner_rule_miss_count": max_owner_rule_miss_count,
                "max_owner_unused_count": max_owner_unused_count,
                "max_duplicate_owner_missing_count": max_duplicate_owner_missing_count,
            },
