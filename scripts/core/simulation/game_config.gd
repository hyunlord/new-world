...
const STARTUP_MODE_PROBE: String = "probe"
const STARTUP_MODE_SANDBOX: String = "sandbox"
const PROBE_START_POPULATION: int = 2
const PROBE_START_SPAWN_RADIUS: int = 8
const PROBE_START_SETTLEMENT_FOOD: float = 6.0
const PROBE_START_SETTLEMENT_WOOD: float = 3.0
const PROBE_START_SETTLEMENT_STONE: float = 1.0
const SANDBOX_START_SETTLEMENT_FOOD: float = 15.0
const SANDBOX_START_SETTLEMENT_WOOD: float = 5.0
const SANDBOX_START_SETTLEMENT_STONE: float = 2.0
const PROBE_START_AGE_YEARS: Array[int] = [24, 22]
const PROBE_START_DAY_OFFSETS: Array[int] = [32, 196]
const PROBE_START_SEXES: Array[String] = ["male", "female"]
...
## Simulation runtime backend mode: rust_primary (only supported mode).
const SIM_RUNTIME_MODE_RUST_PRIMARY: String = "rust_primary"
const SIM_RUNTIME_MODE: String = SIM_RUNTIME_MODE_RUST_PRIMARY
